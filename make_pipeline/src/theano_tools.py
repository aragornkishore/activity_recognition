...
theano_divide_row = theano.function([theano_matrix1, theano_row_vector], theano_matrix1 / theano_row_vector, name='theano_divide_row')
...
theano_sum_of_squares = theano.function(inputs=[theano_matrix1], outputs=T.sum(theano_matrix1**2, axis=1), name='theano_sum_of_squares')
